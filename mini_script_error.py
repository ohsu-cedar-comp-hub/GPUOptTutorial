...
import pandas as pd
import os
os.environ['HF_HOME'] = "/home/exacloud/gscratch/CEDAR/chaoe/cache/" 
os.environ["HUGGINGFACE_HUB_CACHE"] = "/home/exacloud/gscratch/CEDAR/chaoe/cache/"
...
class ImageCropTileFilter:
    def __init__(self, imageLoc, hf_token: str, output_dir: str):
...
if __name__ == "__main__":
    ...
    os.environ['HF_HOME'] = '/home/exacloud/gscratch/CEDAR/chaoe/gpu_opt/cache/'
    ...
    for image in os.listdir(args.image_directory):
        ...
        og_img = ImageCropTileFilter(image_path, hf_token=hugging_face_token, output_dir = output_dir )
